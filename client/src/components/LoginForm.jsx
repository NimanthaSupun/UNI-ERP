...
const LoginForm = ({ role, onNavigate }) => {
  ...
  const getRoleInfo = () => {
    switch (role) {
      case 'student':
        return { title: 'Student Portal', color: 'from-blue-500 to-blue-600', icon: GraduationCap };
      case 'lecturer':
        return { title: 'Lecturer Portal', color: 'from-emerald-500 to-emerald-600', icon: BookOpen };
      case 'coordinator':
        return { title: 'Coordinator Portal', color: 'from-purple-500 to-purple-600', icon: Users };
      default:
        return { title: 'Login', color: 'from-gray-500 to-gray-600', icon: GraduationCap };
    }
  };
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white/10 backdrop-blur-xl rounded-3xl p-8 border border-white/20 shadow-2xl">
            ...
            <div className="mt-6 p-4 bg-white/5 rounded-xl">
              ...
              {role === 'lecturer' && (
                <p className="text-slate-400 text-xs">
                  Email: jane.lecturer@university.edu<br />
                  Password: password123
                </p>
              )}
              {role === 'coordinator' && (
                <p className="text-slate-400 text-xs">
                  Email: admin.coordinator@university.edu<br />
                  Password: password123
                </p>
              )}
            </div>
